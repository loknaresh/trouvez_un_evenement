...
<html>
	...
	<body>
        ...
        <div class="containeur_carte"> 
            <form method="GET" action="">
                <table style="width: 100%;">
                    <tr>
                        <td>Date de début : <input type="date" name="date_debut" value="<?php echo $date_debut; ?>"></td>
                        <td>Date de fin : <input type="date" name="date_fin" value="<?php echo $date_fin; ?>"></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <button type="submit" class="btn-primary" style="margin-top: 10px;">Afficher les événements</button>
                        </td>
                    </tr>
                </table>
            </form>
